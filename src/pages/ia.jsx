  ...
  <div className="row g-0 g-md-4 mx-0">
    ...
    <div className="bg-white rounded-3 shadow-sm p-3 me-0 me-md-2" style={{position: 'sticky', top: 87, maxHeight: 'calc(100vh - 40px)', overflowY: 'auto'}}>
        ...
        <div className="mb-2">
            ...
            <a className="nav-link px-0 py-1 text-secondary small" href="#présentation_rl">Présentation</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#definition_rl">Définition</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#pdm">Processus de décision markovien</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#bellman">Fonctions de valeur et équations de Bellman</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#gradient">Gradient de politique</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#choix-algo">Présentation des algorithmes</a>
            </div>
        </div>
        ...
        <div className="mb-2">
            ...
            <a className="nav-link px-0 py-1 text-secondary small" href="#sac-def">Définition</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#sac-objectif">Objectif</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#sac-fonctionnement">Principe de fonctionnement</a>
            </div>
        </div>
        ...
        <div className="mb-2">
            ...
            <a className="nav-link px-0 py-1 text-secondary small" href="#jumeau-concept">Concept de jumeau numérique</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#moteurs">Moteurs de simulation physique</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#choix-pybullet">Choix de PyBullet</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#bibliotheques">Bibliothèques d'implémentation</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#choix-cleanrl">Choix de CleanRL</a>
            </div>
        </div>
        ...
        <div className="mb-2">
            ...
            <a href="#besoins" className="text-dark text-decoration-none" style={{cursor: 'pointer'}}>
                <i className="bi bi-list-check text-primary me-2" />4. Analyse des besoins
            </a>
            ...
            <a className="nav-link px-0 py-1 text-secondary small" href="#besoins-fonctionnels">Besoins fonctionnels</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#besoins-non-fonctionnels">Besoins non fonctionnels</a>
            </div>
        </div>
        ...
        <div className="mb-2">
            ...
            <a href="#config-env" className="text-dark text-decoration-none" style={{cursor: 'pointer'}}>
                <i className="bi bi-gear-fill text-primary me-2" />5. Configuration de l'environnement
            </a>
            ...
            <a className="nav-link px-0 py-1 text-secondary small" href="#anaconda">Création de l'espace de développement</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#dependances">Installation des dépendances</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#verif-install">Vérification de l'installation</a>
            </div>
        </div>
        ...
        <div className="mb-2">
            ...
            <a href="#niryoenv" className="text-dark text-decoration-none" style={{cursor: 'pointer'}}>
                <i className="bi bi-robot text-primary me-2" />6. Conception de NiryoEnv
            </a>
            ...
            <a className="nav-link px-0 py-1 text-secondary small" href="#architecture-env">Architecture générale</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#modelisation">Modélisation du bras</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#espace-action">Espace d'action</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#espace-observation">Espace d'observation</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#recompense">Fonction de récompense</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#cible-aleatoire">Génération de la cible</a>
            </div>
        </div>
        ...
        <div className="mb-2">
            ...
            <a href="#entrainement" className="text-dark text-decoration-none" style={{cursor: 'pointer'}}>
                <i className="bi bi-graph-up-arrow text-primary me-2" />7. Apprentissage par renforcement
            </a>
            ...
            <a className="nav-link px-0 py-1 text-secondary small" href="#architecture-script">Architecture du script</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#hyperparametres">Hyperparamètres</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#boucle">Boucle d'entraînement</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#lancement">Lancement de l'entraînement</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#resultats">Résultats du premier cycle</a>
            </div>
        </div>
        ...
        <div className="mb-2">
            ...
            <a href="#benchmark" className="text-dark text-decoration-none" style={{cursor: 'pointer'}}>
                <i className="bi bi-speedometer2 text-primary me-2" />8. Benchmark et tests
            </a>
            ...
            <a className="nav-link px-0 py-1 text-secondary small" href="#versions-env">Comparaison des versions</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#script-evaluation">Script d'évaluation</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#resultats-benchmark">Résultats du benchmark</a>
            </div>
        </div>
        ...
        <div className="mb-2">
            ...
            <a className="nav-link px-0 py-1 text-secondary small" href="#figure01">Figure 1</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#figure02">Figure 2</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#figure03">Figure 3</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#figure04">Figure 4</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#figure05">Figure 5</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#figure06">Figure 6</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#figure07">Figure 7</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#figure08">Figure 8</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#figure09">Figure 9</a>
            ...
            <a className="nav-link px-0 py-1 text-secondary small" href="#IA_Figure20">Figure 20</a>
        ...
        */}
        ...
        <div className="mb-2">
            ...
            <a className="nav-link px-0 py-1 text-secondary small" href="#tableau01">Tableau 1</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#tableau02">Tableau 2</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#tableau03">Tableau 3</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#tableau04">Tableau 4</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#tableau05">Tableau 5</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#tableau06">Tableau 6</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#tableau07">Tableau 7</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#tableau08">Tableau 8</a>
            <a className="nav-link px-0 py-1 text-secondary small" href="#tableau09">Tableau 9</a>
    ...
    <div className="col-md-9 ps-0 ps-md-2 pe-0">
      <div id="cadrage" className="bg-white rounded-3 shadow-sm p-4 mb-4">
        <h2 className="text-primary border-bottom pb-2 mb-4"><i className="bi bi-book-fill" /> 1. APPRENTISSAGE PAR Reinforcement</h2>
        {/* doc tech */}
        <div id="présentation_rl">
          <h3 className="text-dark fw-bold"> Présentation de l'Apprentissage par Reinforcement</h3>
          <p>La robotique de manipulation est un domaine de recherche dynamique où l'automatisation de tâches complexes
            via des bras articulés se heurte aux limites des méthodes de contrôle classiques face à l'incertitude 
            environnementale. Dans ce contexte, l'apprentissage par reinforcement (RL) s'impose comme une alternative 
            prometteuse, capable de générer des politiques de contrôle optimales par interaction directe plutôt que par modélisation exhaustive.<br />
            Ce chapitre structure l'étude autour des
            fondements du RL, de l'algorithme SAC, de la simulation physique et des écosystèmes
            logiciels, afin de traduire ces concepts théoriques en exigences opérationnelles
        ...
        <div id="pdm" className="mt-5">
          <h3 className="text-dark fw-bold"> Le processus de décision markovien</h3>
          {/* doc tech */}
        ...
        <div id="gradient" className="mt-5">
          <h3 className="text-dark fw-bold">Gradient de politique</h3>
          {/* doc tech */}
        ...
        <div id="choix-algo" className="mt-5">
          <h3 className="text-dark fw-bold">Présentation des algorithmes de reinforcement learning</h3>
          {/* doc tech */}
          ...
          <div id="tableau01" className="table-responsive">
      ...
      <div id="sac" className="bg-white rounded-3 shadow-sm p-4 mb-4">
        ...
        <div id="sac-fonctionnement" className="mt-5">
          <h3 className="text-dark fw-bold"> Principe de fonctionnement</h3>
          {/* doc tech */}
          ...
          <div id="figure01" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{height: 350}}>
            <img src="images/IA_Figure01.png" className="img-fluid" style={{maxHeight: '100%', objectFit: 'contain'}} />
          </div>
          ...
          <div id="figure02" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{height: 350}}>
      ...
      <div id="jumeau" className="bg-white rounded-3 shadow-sm p-4 mb-4">
        ...
        <div id="jumeau-concept">
          <h3 className="text-dark fw-bold"> Présentation du concept de jumeau numérique</h3>
          {/* doc tech */}
        ...
        <div id="moteurs" className="mt-5">
          <h3 className="text-dark fw-bold"> Présentation des moteurs de simulation physique</h3>
          {/* doc tech */}
          <div id="tableau02" className="table-responsive">
        ...
        <div id="choix-pybullet" className="mt-5">
          <h3 className="text-dark fw-bold"> Choix de PyBullet et justification</h3>
          {/* doc tech */}
        ...
        <div id="bibliotheques" className="mt-5">
          <h3 className="text-dark fw-bold">Bibliothèques d'implémentation algorithmique</h3>
          {/* doc tech */}
          <p>Plusieurs bibliothèques proposent des implémentations de référence des algorithmes RL :</p>
          <div id="tableau03" className="table-responsive">
            <table className="table table-bordered">
        ...
        <div id="choix-cleanrl" className="mt-5">
          <h3 className="text-dark fw-bold">Choix de CleanRL et justification</h3>
          {/* doc tech */}
      ...
      <div id="besoins" className="bg-white rounded-3 shadow-sm p-4 mb-4">
        ...
        <div id="besoins-fonctionnels">
          <h3 className="text-dark fw-bold"> Besoins fonctionnels</h3>
          {/* doc tech */}
          <div id="tableau04" className="table-responsive">
            <table className="table table-bordered table-sm">
        ...
        <div id="besoins-non-fonctionnels" className="mt-5">
          <h3 className="text-dark fw-bold"> Besoins non fonctionnels</h3>
          {/* doc tech */}
          <div id="tableau05" className="table-responsive">
            <table className="table table-bordered">
          ...
          <p>Le projet s'inscrit ainsi dans la continuité directe des pratiques de simulation-first
            établies par les travaux pionniers d'OpenAI. L'objectif de généralisation vers un transfert
            sim-to-real, bien que hors du périmètre du présent travail, sera facilité par la fidélité de
      ...
      <div id="config-env" className="bg-white rounded-3 shadow-sm p-4 mb-4">
        ...
        <div id="anaconda">
          <h3 className="text-dark fw-bold"> Création de l'espace de développement sous Anaconda</h3>
          {/* doc tech */}
          ...
          <p className="text-center small mt-1">Figure 3 : Script environnement virtuel</p>
          <div id="figure03" />
        ...
        <div id="dependances" className="mt-5">
          <h3 className="text-dark fw-bold"> Installation des dépendances</h3>
          {/* doc tech */}
          ...
          <p className="text-center small mt-1">Figure 4 : Script installation PyTorch</p>
          <div id="figure04" />
          ...
          <p className="text-center small mt-1">Figure 5 : Script installation PyBullet</p>
          <div id="figure05" />
          ...
          <p className="text-center small mt-1">Figure 6 : Script installation Gymnasium</p>
          <div id="figure06" />
          ...
          <p className="text-center small mt-1">Figure 7 : Script installation CleanRL</p>
          <div id="figure07" />
          ...
          <p className="text-center small mt-1">Figure 8 : Script installation Tensorboard</p>
          <div id="figure08" />
        </div>
        <div id="verif-install" className="mt-5">
          <h3 className="text-dark fw-bold"> Vérification de l'installation</h3>
          {/* doc tech */}
          ...
          <p className="text-center small mt-1">Figure 9 : Script test fonctionnel chargement du modèle URDF et contrôle interactif des articulations</p>
          <div id="figure09" />
          ...
          <h3 className="text-dark fw-bold">Synthèse de l'environnement de travail</h3>
          <div id="tableau06" className="table-responsive">
            <table className="table table-bordered">
      ...
      <div id="niryoenv" className="bg-white rounded-3 shadow-sm p-4 mb-4">
        ...
        <div id="architecture-env">
          <h3 className="text-dark fw-bold"> Architecture générale de la classe NiryoEnv</h3>
          {/* doc tech */}
          ...
          <div id="tableau07" className="table-responsive">
            <table className="table table-bordered">
        ...
        <div id="modelisation" className="mt-5">
          <h3 className="text-dark fw-bold"> Modélisation du bras Niryo Ned</h3>
          {/* doc tech */}
          ...
          <p className="text-center small mt-1">Figure 10 : Script chargement modèle URDF avec base fixée au sol</p>
          <div id="figure10" />
        ...
        <div id="espace-action" className="mt-5">
          <h3 className="text-dark fw-bold"> Définition de l'espace d'action</h3>
          {/* doc tech */}
        ...
        <div id="espace-observation" className="mt-5">
          <h3 className="text-dark fw-bold">Définition de l'espace d'observation</h3>
          {/* doc tech */}
        ...
        <div id="recompense" className="mt-5">
          <h3 className="text-dark fw-bold">Conception de la fonction de récompense</h3>
          {/* doc tech */}
          ...
          <div id="tableau08" className="table-responsive">
            <table className="table table-bordered">
        ...
        <div id="cible-aleatoire" className="mt-5">
          <h3 className="text-dark fw-bold">Initialisation et génération de la cible aléatoire</h3>
          {/* doc tech */}
          ...
          <div id="figure14" />
          <p>L'architecture de NiryoEnv est optimisée pour transformer une simulation physique brute en un problème d'apprentissage par reinforcement soluble et performant. Sa conception repose sur trois piliers :</p>
          <ul>
      ...
      <div id="entrainement" className="bg-white rounded-3 shadow-sm p-4 mb-4">
        ...
        <div id="architecture-script">
          <h3 className="text-dark fw-bold"> Architecture du script d'entraînement</h3>
          <h4 className="text-dark fw-bold">Adaptation de CleanRL à l'environnement NiryoEnv</h4>
          {/* doc tech */}
          ...
          <div id="figure15" />
          <h4 className="text-dark fw-bold">Architecture des réseaux de neurones</h4>
          ...
          <div id="tableau09" className="table-responsive">
            <table className="table table-bordered table-sm">
        ...
        <div id="hyperparametres" className="mt-5">
          <h3 className="text-dark fw-bold"> Configuration des hyperparamètres</h3>
          {/* doc tech */}
        ...
        <div id="boucle" className="mt-5">
          <h3 className="text-dark fw-bold"> Boucle d'entraînement</h3>
          <h4 className="text-dark fw-bold"> Phase d’exploration et mises à jour</h4>
          {/* doc tech */}
          ...
          <h4 className="text-dark fw-bold">Sauvegarde du modèle</h4>
        ...
        <div id="lancement" className="mt-5">
          <h3 className="text-dark fw-bold">Lancement de l'entraînement</h3>
          {/* doc tech */}
        ...
        <div id="resultats" className="mt-5">
          <h3 className="text-dark fw-bold">Résultats du premier cycle d'entraînement</h3>
          <h4 className="text-dark fw-bold">Récompense épisodique (episodic return)</h4>
          {/* doc tech */}
          <p>Ce figure présente l'évolution de la récompense cumulée par épisode sur les 300 000 pas de temps du premier cycle d'entraînement.</p>
          ...
          <h3 className="text-dark fw-bold">Synthèse et perspectives</h3>
      ...
      <div id="benchmark" className="bg-white rounded-3 shadow-sm p-4 mb-4">
        ...
        {/* doc tech + rapport */}
        <h3 className="text-dark fw-bold">Introduction et protocole d'évaluation</h3>
        ...
        <div id="versions-env" className="mt-5">
          ...
          <p className="text-center small mt-1">Tableau 11 : Récapitulatif comparatif des trois versions d'environnement</p>
          <h4 className="text-dark fw-bold">Analyse des choix de conception par version</h4>
          {/* doc tech */}
        ...
        <div id="script-evaluation">
          <h3 className="text-dark fw-bold">Script d'évaluation</h3>
          <h4 className="text-dark fw-bold">Architecture et méthodologie</h4>
          {/* doc tech */}
          ...
          <h4 className="text-dark fw-bold">Détection de blocage</h4>
          ...
          <h4 className="text-dark fw-bold">Métriques collectées</h4>
          <p>En fin de chaque épisode, un bilan complet de trajectoire est affiché et enregistré, regroupant l'ensemble des indicateurs de performance de l'effecteur : </p>
          <div id="tableau12" className="table-responsive">
            <table className="table table-bordered table-sm">
              ...
              <tbody>
                <tr>
                  <td>Distance EEF → cible</td>
                  <td>mètres</td>
                  <td>info["distance"]</td>
                  <td>Précision finale du positionnement</td>
                </tr>
                <tr>
                  <td>Erreur moyenne épisode</td>
                  <td>mètres</td>
                  <td>np.mean(episode_errors)</td>
                  <td>Qualité globale de la trajectoire</td>
                </tr>
                <tr>
                  <td>Nombre de steps</td>
                  <td>pas</td>
                  <td>step_count</td>
                  <td>Efficacité temporelle de la politique</td>
                </tr>
                <tr>
                  <td>Récompense cumulée</td>
                  <td>score</td>
                  <td>episode_reward</td>
                  <td>Performance globale selon la récompense</td>
                </tr>
                <tr>
                  <td>Position EEF (x,y,z)</td>
                  <td>mètres</td>
                  <td>info["eef_x/y/z"]</td>
                  <td>Localisation finale de l'effecteur</td>
                </tr>
                <tr>
                  <td>Orientation (RPY)</td>
                  <td>degrés</td>
                  <td>info["roll/pitch/yaw"]</td>
                  <td>Orientation de l'effecteur à l'arrêt</td>
                </tr>
                <tr>
                  <td>Vitesse linéaire EEF</td>
                  <td>m/s</td>
                  <td>info["eef_velocity"]</td>
                  <td>Fluidité du mouvement en fin de trajectoire</td>
                </tr>
                <tr>
                  <td>Positions joints</td>
                  <td>degrés</td>
                  <td>info["joint_positions"]</td>
                  <td>Configuration articulaire finale</td>
                </tr>
              </tbody>
            </table>
            <p className="text-center small mt-1">Tableau 12 : Métriques collectées en fin d'épisode</p>
          </div>
        </div>
        <div id="resultats-benchmark" className="mt-5">
          <h3 className="text-dark fw-bold">Résultats du benchmark</h3>
          {/* doc tech */}
          <h4 className="fw-bold mt-3">Introduction et protocole d'évaluation</h4>
          <p>La phase de benchmark compare les trois versions d'environnement selon deux métriques : précision spatiale et performance de calcul (SPS).</p>
          {/* Figure 20 : SPS */}
          {/* Figure 20 : SPS */}
          <div id="IA_Figure20" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{height: 250}}>
            <img src="images/IA_Figure21.png" className="img-fluid" style={{maxHeight: '100%', objectFit: 'contain'}} alt="Débit de simulation SPS sur 300 000 timesteps" />
          </div>
          <p className="text-center small mt-1">Figure 20 : Débit de simulation SPS (steps per second) sur 300 000 timesteps</p>
          <p>Les trois runs démarrent à un SPS élevé entre 15 et 18 puis décroissent rapidement. <strong>NiryoEnv v0</strong> se stabilise autour de 10 et 11 SPS, soit un débit nettement supérieur aux deux autres versions, ce qui est cohérent avec sa configuration plus simple (moins de sous-pas, espace d'observation réduit). <strong>NiryoEnv v1</strong> et <strong>v2</strong> convergent vers 3 et 5 SPS, avec un plancher temporaire à 3 SPS entre 100k et 150k pas, correspondant à la saturation du replay buffer.</p>
          <h4 className="fw-bold mt-3"> Perte de l’acteur</h4>
          {/* Figure 21 : Actor Loss */}
          <div id="IA_Figure21" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{height: 250}}>
            <img src="images/IA_Figure22.png" className="img-fluid" style={{maxHeight: '100%', objectFit: 'contain'}} alt="Perte de l'acteur sur 300 000 timesteps" />
          </div>
          <p className="text-center small mt-1">Figure 21 : Perte de l'acteur (actor loss) sur 300 000 timesteps</p>
          <p>Les trois versions présentent des dynamiques radicalement différentes. NiryoEnv v1 affiche une
            perte croissante de 0 à +30 sur l'ensemble de l'entraînement : cette croissance monotone est
            typique d'un SAC qui maximise activement la valeur Q estimé signal d'apprentissage discriminant.
            NiryoEnv v2 présente une perte qui converge rapidement vers 0 : le gradient constant de la
            récompense linéaire −d est peu discriminant à proximité de la cible. NiryoEnv v0 plonge à −21 puis
            remonte progressivement vers 0, révélant une instabilité initiale liée à l'amplitude excessive des
            actions.</p>
          {/* Tableau 13 : Comparaison des trois versions */}
          <div id="tableau13" className="table-responsive mt-4">
            <table className="table table-bordered table-sm">
              <thead className="table-primary">
                <tr>
                  <th>Caractéristique</th>
                  <th>NiryoEnv v0 (violet)</th>
                  <th>NiryoEnv v1 (vert)</th>
                  <th>NiryoEnv v2 (orange)</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td><strong>Espace d'action</strong></td>
                  <td>6D position directe</td>
                  <td>4D delta (×0,05 rad)</td>
                  <td>4D delta (×0,05 rad)</td>
                </tr>
                <tr>
                  <td><strong>Observation</strong></td>
                  <td>12D non normalisées</td>
                  <td>18D norm. [-1,1]</td>
                  <td>18D norm. [-1,1]</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><strong>Bonus atteinte</strong></td>
                  <td>Aucun</td>
                  <td>+5,0 si d &lt; 0,05 m</td>
                  <td>+5,0 si d &lt; 0,05 m</td>
                </tr>
                <tr>
                  <td><strong>SPS stable</strong></td>
                  <td>~10–11</td>
                  <td>~3–5</td>
                  <td>~3–5</td>
                </tr>
                <tr>
                  <td><strong>Actor loss</strong></td>
                  <td>Instable → 0</td>
                  <td>Croissante (discriminant)</td>
                  <td>Stable ≈ 0 (faible)</td>
                </tr>
              </tbody>
            </table>
            <p className="text-center small mt-1">Tableau 13 : Comparaison des trois versions d'environnement</p>
          </div>
          <h4 className="fw-bold mt-3">Conclusion benchmark</h4>
          <p><strong>NiryoEnv v1</strong> avec récompense exponentielle exp(−20·d) offre le signal d'apprentissage le plus discriminant et sera retenu pour les cycles futurs.</p>
        </div>
      </div>
    </div>
  </div>
