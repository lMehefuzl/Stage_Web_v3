            ...
            <nav className="nav flex-column">
                ...
                <div className="mb-2">
                    ...
                    <div className="collapse ps-4" id="collapseResumeRos">
                        ...
                        <a className="nav-link px-0 py-1 text-secondary small ps-3" href="#noeuds"> Noeuds</a>
                ...
                {/* 5. LIEN AVEC LA THÉORIE */}
                <div className="mb-2">
                    <div className="nav-link px-0 py-1 text-dark d-flex justify-content-between align-items-center">
                        <a href="#intro" className="text-dark text-decoration-none" style={{ cursor: 'pointer' }}>
                            <i className="bi bi-puzzle text-primary me-2"></i>Lien avec la théorie
                        </a>
                        <i className="bi bi-chevron-down small" data-bs-toggle="collapse" data-bs-target="#collapseLienTheorie" aria-expanded="false" style={{ cursor: 'pointer' }}></i>
                    </div>
                    <div className="collapse ps-4" id="collapseLienTheorie">
                        <a className="nav-link px-0 py-1 text-secondary small" href="#exemple-move-pose">1. Exemple 1 : move_pose (MGD)</a>
                        <a className="nav-link px-0 py-1 text-secondary small" href="#exemple-move-joints">2. Exemple 2 : move_joints (MGI)</a>
                        <a className="nav-link px-0 py-1 text-secondary small" href="#Résumé_schématique">3. Résumé schématique</a>
                    </div>
                </div>
      ...
      <div className="bg-white rounded-3 shadow-sm p-4 mb-4">
        ...
        <div id="intro" >
          <h2 className="text-primary border-bottom pb-2 mb-4">
            <i className="bi bi-puzzle" /> LIEN AVEC LA THÉORIE
          </h2>
          <p>
