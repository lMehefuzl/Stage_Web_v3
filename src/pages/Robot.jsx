      ...
      <div className="row g-0 g-md-4 mx-0">
        ...
        <div className="col-md-3 ps-0 pe-0 pe-md-2">
          <div className="bg-white rounded-3 shadow-sm p-3 me-0 me-md-2" style={{ position: 'sticky', top: '20px', maxHeight: 'calc(100vh - 40px)', overflowY: 'auto' }}>
            ...
            <nav className="nav flex-column">
              <a className="nav-link px-0 py-1 text-dark" href="#description"><i className="bi bi-info-circle text-primary me-2"></i>1. Description du robot</a>
              <div className="ps-4">
                <a className="nav-link px-0 py-1 text-secondary small" href="#generalites">a) Généralités</a>
                <a className="nav-link px-0 py-1 text-secondary small" href="#connectiques">b) Connectiques</a>
                <a className="nav-link px-0 py-1 text-secondary small" href="#architecture">c) Architecture électrique</a>
                <a className="nav-link px-0 py-1 text-secondary small" href="#alimentation">d) Alimentation</a>
                <a className="nav-link px-0 py-1 text-secondary small" href="#modes">e) Mode opératoire</a>
              </div>
              <a className="nav-link px-0 py-1 text-dark mt-2" href="#accessoires"><i className="bi bi-tools text-primary me-2"></i>2. Les accessoires</a>
              <div className="ps-4">
                <a className="nav-link px-0 py-1 text-secondary small" href="#grippers">a) Grippers</a>
                <a className="nav-link px-0 py-1 text-secondary small" href="#electroaimant">b) Électroaimant</a>
                <a className="nav-link px-0 py-1 text-secondary small" href="#pompe">c) Pompe à vide</a>
              </div>
              <a className="nav-link px-0 py-1 text-dark mt-2" href="#boutons"><i className="bi bi-grid-3x3-gap-fill text-primary me-2"></i>3. Les boutons</a>
              <div className="ps-4">
                <a className="nav-link px-0 py-1 text-secondary small" href="#bouton-wifi">a) Bouton Wi-Fi</a>
                <a className="nav-link px-0 py-1 text-secondary small" href="#bouton-sup">b) Bouton supérieur</a>
                <a className="nav-link px-0 py-1 text-secondary small" href="#panneau">c) Panneau de contrôle</a>
              </div>
              <a className="nav-link px-0 py-1 text-dark mt-2" href="#securite"><i className="bi bi-shield-lock-fill text-primary me-2"></i>4. Sécurité</a>
              <a className="nav-link px-0 py-1 text-dark mt-2" href="#anneau-led"><i className="bi bi-lightbulb-fill text-primary me-2"></i>5. Indications anneau LED</a>
              <a className="nav-link px-0 py-1 text-dark mt-2" href="#autres"><i className="bi bi-three-dots text-primary me-2"></i>6. Autres</a>

              <div className="border-top mt-3 pt-2">
                <p className="text-primary fw-semibold small mb-1"><i className="bi bi-image text-primary me-1"></i> Figures :</p>
                <div className="ps-3">
                  ...
                  <a className="nav-link px-0 py-1 text-secondary small" href="#figure28">Figure 28</a>
                  <a className="nav-link px-0 py-1 text-secondary small" href="#figure29">Figure 29</a>
                </div>
              </div>

              <div className="border-top mt-3 pt-2">
                <p className="text-primary fw-semibold small mb-1"><i className="bi bi-table text-primary me-1"></i> Tableaux :</p>
                <div className="ps-3">
        ...
        <div className="col-md-9 ps-0 ps-md-2 pe-0">
          ...
          <div id="description" className="bg-white rounded-3 shadow-sm p-4 mb-4">
            <h2 className="text-primary border-bottom pb-2 mb-4"><i className="bi bi-info-circle-fill"></i> 1. DESCRIPTION DU ROBOT</h2>

            {/* FIGURE 1 et 2 */}
            <div className="row g-3 mb-4">
              <div className="col-md-6">
                <div id="figure1" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center" style={{ height: '250px' }}>
                  <img src="/images/Figure1.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Niryo Ned2" />
                </div>
                <p className="text-center small mt-1">Figure 1 : Image du robot Niryo Ned2</p>
              </div>
              <div className="col-md-6">
                <div id="figure2" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center" style={{ height: '250px' }}>
                  <img src="/images/Figure2.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Cotes du robot" />
                </div>
            ...
            <div id="generalites">
              <h3 className="text-dark">Généralités</h3>
              <p>Le Niryo Ned2 est un <strong>COBOT (robot collaboratif)</strong> à vocation éducative et de recherche. Par commodité, nous utiliserons le terme de « robot » pour parler du Ned2 tout au long de ce guide.</p>
            ...
            <div id="connectiques" className="mt-5">
              <h3 className="text-dark">Connectiques</h3>

              <div className="row g-3 mb-4">
                <div className="col-md-6">
                  <div id="figure3" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center" style={{ height: '240px' }}>
                    <img src="/images/Figure3.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Panneau arrière caractéristiques" />
                  </div>
                  <p className="text-center small mt-1">Figure 3 : Caractéristiques du panneau arrière de la base</p>
                </div>
                <div className="col-md-6">
                  <div id="figure4" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center" style={{ height: '240px' }}>
                    <img src="/images/Figure4.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Panneau arrière" />
                  </div>
                  <p className="text-center small mt-1">Figure 4 : Panneau arrière de la base</p>
                </div>
              </div>

              <h4 className="mt-4">Entrées numériques :</h4>
              ...
              <div id="tableau2" className="table-responsive">
                <table className="table table-bordered table-sm">
                  <thead className="table-primary">
                    <tr><th>Connecteur</th><th>Paramètre</th><th>Min</th><th>Max</th><th>Unité</th></tr>
                  </thead>
                  <tbody>
                    <tr className="table-secondary fw-bold"><td colSpan="5">Entrée numérique : type → NPN</td></tr>
                    <tr><td className="fw-bold">[DI1 - DI2 - DI3]</td><td className="fw-bold">Tension</td><td>0</td><td>5</td><td>V</td></tr>
                    <tr><td></td><td className="fw-bold">Courant</td><td>0</td><td>5</td><td>mA</td></tr>
                  </tbody>
                </table>
              </div>
              ...
              <div id="figure5" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '150px' }}>
                <img src="/images/Figure5.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Schéma connexion bouton" />
              </div>
              <p className="text-center small mt-1">Figure 5 : Schéma de connexion d'un bouton sur une entrée numérique</p>

              <h4 className="mt-4">Sorties numériques :</h4>
              ...
              <div id="tableau3" className="table-responsive">
                <table className="table table-bordered table-sm">
                  ...
                  <tbody>
                    <tr className="table-secondary fw-bold"><td colSpan="5">Sortie numérique : type → PNP</td></tr>
                    <tr><td className="fw-bold">[DO1 - DO2 - DO3]</td><td className="fw-bold">Tension</td><td>0</td><td>5</td><td>V</td></tr>
                    <tr><td></td><td className="fw-bold">Courant</td><td>0</td><td>250</td><td>mA</td></tr>
                  </tbody>
                </table>
              </div>
              ...
              <div id="figure6" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '150px' }}>
                <img src="/images/Figure6.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Schéma connexion charge" />
              </div>
              <p className="text-center small mt-1">Figure 6 : Schéma de connexion d'une charge sur une sortie numérique</p>

              <h4 className="mt-4">Entrées analogiques :</h4>
              <p>Les entrées analogiques peuvent être utilisées pour mesurer la tension (0-5V) d'un équipement.</p>
              <div id="tableau4" className="table-responsive">
                <table className="table table-bordered table-sm">
                  ...
                  <tbody>
                    <tr className="table-secondary fw-bold"><td colSpan="5">Entrée analogique</td></tr>
                    <tr><td className="fw-bold">[AI1 - AI2]</td><td className="fw-bold">Tension</td><td>0</td><td>5</td><td>V</td></tr>
                    <tr><td></td><td className="fw-bold">Courant</td><td>0</td><td>20</td><td>mA</td></tr>
                    <tr><td></td><td className="fw-bold">Résolution</td><td>-</td><td>12</td><td>bits</td></tr>
                  </tbody>
                </table>
              </div>
              ...
              <div id="figure7" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '150px' }}>
                <img src="/images/Figure7.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Schéma connexion potentiomètre" />
              </div>
              <p className="text-center small mt-1">Figure 7 : Schéma de connexion d'un potentiomètre sur une entrée analogique</p>

              <h4 className="mt-4">Sorties analogiques :</h4>
              <p>Les sorties analogiques peuvent être utilisées pour paramétrer la tension (0-5V) d'un équipement.</p>
              <div id="tableau5" className="table-responsive">
                <table className="table table-bordered table-sm">
                  ...
                  <tbody>
                    <tr className="table-secondary fw-bold"><td colSpan="5">Sortie analogique</td></tr>
                    <tr><td className="fw-bold">[AO1 - AO2]</td><td className="fw-bold">Tension</td><td>0</td><td>5</td><td>V</td></tr>
                    <tr><td></td><td className="fw-bold">Courant</td><td>0</td><td>30</td><td>mA</td></tr>
                    <tr><td></td><td className="fw-bold">Résolution</td><td>-</td><td>12</td><td>bits</td></tr>
                  </tbody>
                </table>
              </div>
              ...
              <div id="figure8" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '150px' }}>
                <img src="/images/Figure8.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Schéma connexion charge analogique" />
              </div>
            ...
            <div id="architecture" className="mt-5">
              <h3 className="text-dark">c) Architecture électrique du cobot Ned2</h3>
              <div id="figure9" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '300px' }}>
                <img src="/images/Figure9.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Architecture électrique" />
              </div>
              <p className="text-center small mt-1">Figure 9 : Architecture électrique du robot Ned2</p>
            </div>

            <div id="alimentation" className="mt-5">
              <h3 className="text-dark">Alimentation du robot et de ses composants</h3>
              ...
              <div id="figure10" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '200px' }}>
                <img src="/images/Figure10.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Schéma alimentation" />
              </div>
              ...
              <div id="tableau6" className="table-responsive">
                <table className="table table-bordered table-sm">
                  <thead className="table-primary">
                    <tr><th>Paramètres</th><th>Valeur</th></tr>
                  </thead>
                  <tbody>
              ...
              <p className="text-center small mt-1" id="figure11">Figure 11 : Paramètres d'alimentation</p>
            ...
            <div id="modes" className="mt-5">
              <h3 className="text-dark">e) Mode opératoire du robot</h3>
          ...
          <div id="accessoires" className="bg-white rounded-3 shadow-sm p-4 mb-4">
            <h2 className="text-primary border-bottom pb-2 mb-4"><i className="bi bi-tools"></i> 2. LES ACCESSOIRES</h2>
            ...
            <div id="grippers" className="mb-4">
              <h3 className="text-dark">a) Grippers</h3>
              <div className="row g-3 mb-3">
                <div className="col-md-6">
                  <div id="figure12" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center" style={{ height: '180px' }}>
                    <img src="/images/Figure12.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Pince Custom" />
                  </div>
                  <p className="text-center small mt-1">Figure 12 : Pince Custom</p>
                </div>
                <div className="col-md-6">
                  <div id="figure13" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center" style={{ height: '180px' }}>
                    <img src="/images/Figure13.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Cotes pince Custom" />
                  </div>
              ...
              <div id="figure14" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '180px' }}>
                <img src="/images/Figure14.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Pince large" />
              </div>
              ...
              <div id="figure15" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '180px' }}>
                <img src="/images/Figure15.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Pince adaptatif" />
              </div>
              ...
              <div id="figure16" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '200px' }}>
                <img src="/images/Figure16.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Câblage pinces" />
              </div>
              <p className="text-center small mt-1">Figure 16 : Schéma de câblage des pinces</p>
            </div>

            <div id="electroaimant" className="mb-4">
              <h3 className="text-dark">b) Électroaimant</h3>
              <div id="figure17" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '180px' }}>
                <img src="/images/Figure17.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Électroaimant" />
              </div>
              ...
              <div id="figure18" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '180px' }}>
                <img src="/images/Figure18.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Connectique électroaimant" />
              </div>
              <p className="text-center small mt-1">Figure 18 : Connectique de l'électroaimant</p>
            </div>

            <div id="pompe">
              <h3 className="text-dark">c) Pompe à vide</h3>
              <div id="figure19" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '180px' }}>
                <img src="/images/Figure19.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Pompe à vide" />
              </div>
              ...
              <div id="figure20" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '180px' }}>
                <img src="/images/Figure20.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Câblage pompe à vide" />
              </div>
          ...
          <div id="boutons" className="bg-white rounded-3 shadow-sm p-4 mb-4">
            <h2 className="text-primary border-bottom pb-2 mb-4"><i className="bi bi-grid-3x3-gap-fill"></i> 3. LES BOUTONS</h2>
            ...
            <div id="bouton-wifi" className="mb-4">
              <h3 className="text-dark">a) Bouton Wi-Fi</h3>
              <div id="figure21" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '150px' }}>
                <img src="/images/Figure21.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Bouton wifi" />
              </div>
              ...
              <div id="tableau12" className="table-responsive">
                <table className="table table-bordered">
                  <thead className="table-primary">
                    <tr><th>Fonction</th><th>Type d'action</th><th>Condition</th><th>État après action</th></tr>
                  </thead>
                  <tbody>
            ...
            <div id="bouton-sup" className="mb-4">
              <h3 className="text-dark">b) Bouton supérieur</h3>
              <div id="figure22" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '120px' }}>
                <img src="/images/Figure22.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Bouton supérieur" />
              </div>
              <p className="text-center small mt-1">Figure 22 : Bouton supérieur de la base</p>
              <p>Le bouton supérieur de Ned2 a de multiples fonctionnalités, qui dépendent de la durée de la pression appliquée ou du nombre de pressions. Le tableau qui suit répertorie ces fonctionnalités.</p>
              <div id="tableau13" className="table-responsive">
                <table className="table table-bordered">
                  ...
                  <tbody>
                    <tr className="table-secondary fw-bold"><td colSpan="2">Un programme est en cours d'exécution</td></tr>
                    ...
                    <tr className="table-secondary fw-bold"><td colSpan="2">Un programme est en pause</td></tr>
                    <tr><td className="ps-4">1 appui court (0.1s - 0.2s)</td><td>Reprend le programme</td></tr>
                    <tr><td className="ps-4">1 appui long (&gt;2s)</td><td>Erreur dans le programme</td></tr>
                    <tr className="table-secondary fw-bold"><td colSpan="2">Un programme est défini en lancement automatique</td></tr>
            ...
            <div id="panneau">
              <h3 className="text-dark">c) Panneau de contrôle</h3>
              <div id="figure23" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '150px' }}>
                <img src="/images/Figure23.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Panneau de contrôle" />
              </div>
          ...
          <div id="securite" className="bg-white rounded-3 shadow-sm p-4 mb-4">
            <h2 className="text-primary border-bottom pb-2 mb-4"><i className="bi bi-shield-lock-fill"></i> 4. SÉCURITÉ</h2>
            <p>Pour cette section, il est fortement recommandé de se lire la notice d'utilisation de robot Niryo Ned2, notamment toutes les informations de sécurité. La notice est disponible via le lien suivant : <a href="https://docs.niryo.com/robots/ned2/safety-instructions/" target="_blank" rel="noopener noreferrer">https://docs.niryo.com/robots/ned2/safety-instructions/</a></p>
            <p>Les points suivants répertorient seulement les informations essentielles de sécurité. Un boitier de sécurité est fourni dans le pack du robot. C'est un bouton d'Arrêt d'Urgence (AU). <strong>ATTENTION : il doit toujours être câblé au robot.</strong></p>
            <div id="figure24" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '150px' }}>
              <img src="/images/Figure24.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Bouton AU" />
            </div>
            <p className="text-center small mt-1">Figure 24 : Bouton d'Arrêt d'Urgence (AU)</p>
            <p><strong>Mise en tension du robot :</strong> Branchez le robot sur secteur avec son câble d'alimentation et branchez-y le bouton d'AU. Vérifiez que ce dernier soit désactivé. Avant d'appuyer sur le bouton de mise en Marche/Arrêt, vérifiez que le robot soit fixé correctement et stable. Mais également qu'il n'y a rien autour de lui car, lors de sa mise en marche, la calibration se fait automatiquement et le robot va bouger.</p>
            <div id="figure25" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '150px' }}>
              <img src="/images/Figure25.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Avertissement installation" />
            </div>
            <p className="text-center small mt-1">Figure 25 : Avertissement d'installation</p>
            <div id="figure26" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '150px' }}>
              <img src="/images/Figure26.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Avertissement mise en marche" />
            </div>
            <p className="text-center small mt-1">Figure 26 : Avertissement d'installation, de mise en marche/arrêt</p>
            <div id="figure27" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '150px' }}>
              <img src="/images/Figure27.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Mise en garde" />
            </div>
            ...
            <ul>
              <li><strong>Extinction d'incendie :</strong> Utilisez un extincteur au DIOXYDE DE CARBONE (CO2) en cas d'incendie.</li>
              <li><strong>Arrêt manuel du bras :</strong> si nécessaire, le robot peut être arrêté manuellement par son faible poids, sa force et sa puissance de transmission limitées. Mais il est fortement recommandé d'utiliser les fonctions d'arrêt normales (par le logiciel ou le bouton en haut de la base).</li>
            </ul>
          </div>

          {/* 5. INDICATIONS DE L'ANNEAU LED */}
          <div id="anneau-led" className="bg-white rounded-3 shadow-sm p-4 mb-4">
            <h2 className="text-primary border-bottom pb-2 mb-4"><i className="bi bi-lightbulb-fill"></i> 5. INDICATIONS DE L'ANNEAU LED DE LA BASE</h2>
          ...
          {/* 6. AUTRES */}
          <div id="autres" className="bg-white rounded-3 shadow-sm p-4 mb-4">
            <h2 className="text-primary border-bottom pb-2 mb-4"><i className="bi bi-three-dots"></i> 6. AUTRES</h2>
            <h4>Mise à jour</h4>
            <p>La version logicielle du robot et les versions Firmware des cartes électroniques peuvent être mise à jour en quelques étapes seulement à l'aide de NiryoStudio.</p>
            <div id="figure28" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '120px' }}>
              <img src="/images/Figure28.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Avertissement mise à jour" />
            </div>
            <p className="text-center small mt-1">Figure 28 : Avertissement de mise à jour</p>
            <h4>Maintenance et support</h4>
            <p>Niryo met à votre disposition une équipe support dédiée à la maintenance de votre robot et la résolution des problèmes techniques. Celle-ci vous répondra dans les 48 heures suivant votre demande. Les procédures de maintenance et de réparation doivent être accomplies en respectant les consignes de sécurité (sous partie n°4 et/ou la notice d'utilisation du robot) et les règles énoncées par notre équipe support. Elle pourra également apporter des réponses à vos questions concernant le fonctionnement de votre robot. Contactez notre équipe à l'adresse <a href="mailto:support@niryo.com">support@niryo.com</a> pour plus d'informations.</p>
            <h4>Conseil</h4>
            <div id="figure29" className="border rounded bg-light p-2 d-flex align-items-center justify-content-center mb-1" style={{ height: '250px' }}>
              <img src="/images/Figure29.png" className="img-fluid" style={{ maxHeight: '100%', objectFit: 'contain' }} alt="Conseil test" />
            </div>
            <p className="text-center small mt-1">Figure 29 : Conseil de test</p>
            <h4>Utilisations prévues</h4>
            <p>Le robot Ned2 est destiné à des buts éducatifs et de recherche et développement, principalement :</p>
            <ul>
              <li>Apprentissage de la robotique</li>
              <li>Recherche et développement en robotique</li>
              <li>Simulation et prototypage de scénarios industriels complets type « Pick & Place » ou « Pick & Pack »</li>
              <li>Application matérielle : connecter et contrôler le robot avec des capteurs et des actionneurs externes afin de simuler une application, tout en respectant les conditions définies dans cette instruction</li>
            </ul>
            <h4>Utilisations non-autorisées</h4>
            <ul>
              <li>L'utilisation comme jouet pour enfant</li>
              <li>L'utilisation pour un usage industriel</li>
              <li>L'utilisation pour la manipulation d'objets inappropriés (avec pinces inadaptées, objets dont la masse est supérieure à la charge maximale autorisée)</li>
              <li>L'utilisation en dehors des spécifications annoncées</li>
            </ul>
          </div>
